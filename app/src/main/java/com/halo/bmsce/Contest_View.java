...
public class Contest_View extends AppCompatActivity {
    ...
    EditText code;
    String user_type;
    private LinkAdapterC adapter;
    private CollectionReference notebookRef;
    String title_rem,date_rem,month,year,month_name,user,workshop_date_rem,type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = findViewById(R.id.title_wkc);
        description = findViewById(R.id.detail_descriptionc);
        lastdate = findViewById(R.id.lastc);
        remainder=(Button)findViewById(R.id.remainder_btnc);
        ...
        if(user_type.compareTo("faculty")==0) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i=new Intent(Contest_View.this, Add_Contest_Material.class);
        ...
        workshop_date=findViewById(R.id.workshop_datec);
        ...
        final DocumentReference documentReference = fStore.collection("contests")
                .document(userId);
        notebookRef=fStore.collection("contests").document(userId).collection("links");
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                ...
                workshop_date.setText(documentSnapshot.getString("contest_date"));
    ...
    private void setUpRecyclerView(){
        ...
        adapter=new LinkAdapterC(options);
        RecyclerView recyclerView=findViewById(R.id.all_linksc);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(adapter);

        adapter.setOnItemClickListener(new LinkAdapterC.OnItemClickListener() {
            @Override
...
// Add a new document with a generated ID
        documentReference.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(Contest_View.this,"Remainder Set!",Toast.LENGTH_LONG).show();
            }
        });
    }
    @Override
